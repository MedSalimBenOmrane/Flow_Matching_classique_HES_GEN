...
# en haut de main.py
from pnpflow.train_flow_matching_indep import FLOW_MATCHING as FLOW_MATCHING_INDEP
...
def main():
    ...
    print("device", device)
    # ← on attache le device à args pour que define_model() puisse l’utiliser
    args.device = device
    ...
    args.num_workers
        ...
        if args.model == "ot":
            ...
            # couplage indépendant (FM classique)
    ...
    if args.eval:
        ...
        data_loaders = data_loaders = DataLoaders(
            args.dataset,
            args.data_root,
            args.batch_size_ip,
            args.batch_size_ip,
